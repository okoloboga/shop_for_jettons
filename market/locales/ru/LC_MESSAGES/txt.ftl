...
registration-closed = Регистрация закрыта!
                      ...
                      Для возобновления регистрации
                      необходимо пополнить 💳 Кошелек 💳
                      на 🪙0.1 TRON🪙
                      Поддержи проект =)
...
notenough-tokens = 🪙 Недостаточно средств на кошельке! 🪙

                    Итоговая сумма заказа: { $total_order_sum }
                    Средств на кошельке: { $tokens }

notenough-tron = Недостаочно TRON для оплаты комиссии!
                Необходимый минимум: 🪙<code>0.1</code>🪙 TRON
                Пополни кошелек 💳
...
order-notification = <b>Новый заказ!</b>
                     ...
                     В Токенах <b>{ $income_in_tokens }</b> 🪙
                     Чистая прибыль в токенах <b>{ $pure_income_in_tokens }</b> 🪙

account-data = Аккаунт 🆔 <code>{ $user_id }</code>

               Сделано покупок 🛍: <b>{ $purchase }</b>
               На сумму 🪙: <b>{ $purchase_sum }</b>
               ...
               Баланс кошелька 🪙: <code>{ $tokens }</code>
               Купить 🪙 <b></b> 🪙:
...
wrong-description = Введено неверное или слишком 
                    длинное описание!
...
notenough = Не достаточно 🪙🪙!

notenough-tron = Не достаточно 💎TRON💎 для 
                 оплаты комиссии...
                 Необходимо <code>0.1</code> 💎TRON💎 на кошельке
